...
AS
BEGIN
    -- Crear la clave maestra si no existe
    ...
    -- Crear la clave simétrica si no existe
    ...
    -- Encriptar los datos de las columnas
...
BEGIN
    ...
    -- Validación: verificar si el Legajo ya existe
    ...
    -- Insertar el nuevo empleado con encriptación
...
BEGIN
    ...
    -- Validación: verificar si el Legajo ya existe en otro registro
    ...
    -- Actualizar los datos del empleado con encriptación
    UPDATE tienda.Empleado
    SET Legajo = @Legajo,
...
BEGIN
    ...
    SELECT 
        ...
        NULL -- Inicialmente vacío; se llenará luego en el ciclo
    FROM tienda.Empleado
    WHERE Cargo = 'Supervisor' AND Estado = 1;
